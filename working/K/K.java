/*
	K. Modify the utility code so that you have a standalone program
	that reads in all of the data for each respective process. Create
	an unverified block for each line of data in the data file. 
*/

/*
#	To-Do List
#	1) Read Utility Code
#	2) Read in data from all processes
#	3) Create unverified block for each line of data
#
#
*/


//On the course website, there are two files that are labeled "utility" for blockchain, and witht he vagueness of the spec of what is being asked, I'm assuming this is what I'm supposed to do
